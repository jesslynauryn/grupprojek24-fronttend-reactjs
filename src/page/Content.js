    ...
    return (
        <Container>
                ...
                <Row>
                    ...
                    <Col lg={4} md={6}>
                        <Image src="https://images.unsplash.com/photo-1587542513982-535059868fad?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1935&q=80" fluid className="jarakItem"/>

                    </Col>
                    <Col lg={5} md={6}>
                        <Card className="card" style={{border:"none", marginLeft:"-70px", fontFamily:"Georgia, 'Times New Roman', Times, serif;"}}>
