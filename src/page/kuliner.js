...
const Kuliner =()=>{
    return(
        <div>
            ...
            {/* Gallery */}
            <Container>
                <h2 className="tengah">Galery</h2><br/>
                <Row>
                    ...
                    <Col md={4} sm={12} className="galeri">
                        <Row>
                            ...
                            <Image src="https://img-global.cpcdn.com/recipes/8b95dc849794c115/1200x630cq70/photo.jpg" fluid className="jarak"/>
            ...
            <Container >
                <br/>
                <h2>Informasi Mengenai Sate Lilit</h2><br/><br/>
                <Row>
                    <Col lg={3} md={6}>
                        <Image src="https://whattocooktoday.com/wp-content/uploads/2013/09/IMG_1319.jpg" fluid />
                    </Col>
                    ...
                    <Col lg={6} sm={12} className="jarak">
                            <h4>Sate Lilit</h4>
                            <h5>Kuliner khas Bali</h5>
                            <p>Makanan khas Bali memang selalu menggoda selera. Salah satu yang paling populer mungkin bebek betutu. Tetapi sebenarnya pulau dewata masih punya sederet kuliner otentik yang tak kalah nikmat di lidah. Plecing kangkung misalnya.<br/><br/>Sate lilit misalnya. Bicara soal sate lilit, makanan khas Bali yang satu ini pasti digemari pecinta ikan. Pasalnya sate memang dibuat dari fillet ikan yang digiling dan dicetak sebelum dibakar. Karena itulah rasanya pun istimewa. Apalagi dengan paduan bumbu khas Bali yang sarat aroma. Dijamin semakin nikmat saat disantap bersama nasi putih.</p>
            ...
            <Container>
                ...
                <br/><br/>
                <h5>Langkah-Langkah</h5><br/>
                <Card>
                <Row>
                    <Col sm={12} md={4} lg={4}><Image src="https://blue.kumparan.com/image/upload/fl_progressive,fl_lossy,c_fill,q_auto:best,w_1024/v1519293591/igv7ozf5phwxzueb3pqc.png" fluid /></Col>
                    <Col md={6} lg={6} className="hilang">
                        ...
                        <p class="card-text">Campurkan daging ayam dengan bumbu yg sudah dihaluskan, tambahkan kelapa parut dan gula merah yang sudah digerus. Masukan irisan daun jeruk, kaldu bubuk dan sedikit minyak kelapa, aduk semua dengan daging ikan hingga rata</p>
