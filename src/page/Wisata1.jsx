      ...
      <Tabs defaultActiveKey="wni" id="uncontrolled-tab-example" className="mb-3" style={{ padding: "0 60px" }}>
        <Tab eventKey="wni" title="WNI" style={{ padding: "20px 60px 30px" }}>
          ...
          <p>
            ...
            Tes PCR negatif berlaku 2 x 24 jam.
            <br />
            Tes Antigen tidak berlaku, kecuali jika diizinkan oleh KKP bandara keberangkatan dan dilengkapi sertifikat vaksin COVID-19 dosis lengkap (dosis kedua). Jika KKP bandara keberangkatan mengizinkan, maka tes antigen berlaku 1 x 24
            jam.
            <br />
            ...
            <br />
            Khusus keberangkatan dari Bali ke daerah asal penumpang: WNA yang berangkat dari Bali dengan tujuan internasional melalui penerbangan domestik dan transit tidak lebih dari 24 jam di bandara transit, tidak wajib menunjukkan kartu
            vaksinasi
          </p>
        </Tab>
        <Tab eventKey="wna" title="WNA" style={{ padding: "20px 60px 30px" }}>
          ...
          <p>
            ...
            positivity rate yang rendah. Negara yang diizinkan tersebut yaitu Saudi Arabia, United Arab Emirates, Selandia Baru, Kuwait, Bahrain, Qatar, China, India, Jepang, Korea Selatan, Liechtenstein, Italia, Prancis, Portugal, Spanyol,
            ...
            <br />
            Menunjukkan hasil negatif melalui tes RT-PCR di negara asal yang diambil dalam kurun waktu maksimal 3 x 24 jam sebelum keberangkatan dan dilampirkan saat pemeriksaan kesehatan atau e-HAC Internasional Indonesia melalui aplikasi
            PeduliLindungi (download di Android / iOS)
            <br />
